...
class mtcnn():
    def __init__(self,pnet_weight='model_data/pnet.h5',rnet_weight='model_data/rnet.h5',onet_weight='model_data/onet.h5'):
        self.Pnet = create_Pnet(pnet_weight)
        self.Rnet = create_Rnet(rnet_weight)
        self.Onet = create_Onet(onet_weight)
